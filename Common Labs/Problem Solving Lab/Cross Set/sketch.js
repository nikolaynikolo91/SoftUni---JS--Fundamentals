...
function checkIfWon() {
    ...
    for (let square of field) {
        if (square.id == 1 && square.mainValue == 2) {
            rightQuestions++;
        } else if (square.id == 2 && square.mainValue == 1) {
            rightQuestions++;
        } else if (square.id == 3 && square.mainValue == 3) {
            rightQuestions++;
        } else if (square.id == 4 && square.mainValue == 4) {
            rightQuestions++;
        } else if (square.id == 5 && square.mainValue == 3) {
            rightQuestions++;
        } else if (square.id == 8 && square.mainValue == 1) {
            rightQuestions++;
        } else if (square.id == 9 && square.mainValue == 1) {
            rightQuestions++;
        } else if (square.id == 12 && square.mainValue == 3) {
            rightQuestions++;
        } else if (square.id == 13 && square.mainValue == 4) {
            rightQuestions++;
        } else if (square.id == 14 && square.mainValue == 3) {
            rightQuestions++;
        } else if (square.id == 15 && square.mainValue == 1) {
            rightQuestions++;
        } else if (square.id == 16 && square.mainValue == 2) {
            rightQuestions++;
        }


    }
    if (rightQuestions == 12) {
        fill(255);
        textSize(50);
        text('You won!', 200, 50);
        noLoop();
